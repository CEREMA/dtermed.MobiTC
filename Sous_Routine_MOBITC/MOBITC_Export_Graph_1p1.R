...
MOBITC_Export_Graph_1p1<-function(chem_mobitc,chemin_rep_travail,fichier_sque,fichier_trace,fichier_intersection,fichier_evolution,NAxe,NTrace)
{
 ...
 fichier_evolution=as.character(fichier_evolution)
  ...
  return(list(G1,G2,G3,G4,G5,G6,G7,G8,G9,Tracedeg,Traceselline,ligneres$NAxe,ligneres$NTrace,ligneres$WLS,length(extraittab2$Distance),LIM$LIM[extraittab1$marqueur[1]],Squedeg,G10,ligneresprec$NAxe,ligneresprec$NTrace,ligneressuiv$NAxe,ligneressuiv$NTrace))
}
