...
```{r use-optipng, optipng = '-o7', echo=FALSE,warning=FALSE,fig.width=6,fig.height=4.5,out.width=20,out.height=15}
...
```{r optipng = '-o7', echo=FALSE,warning=FALSE,fig.width=6,fig.height=4.5,out.width=200,out.height=150}
